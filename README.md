...
เว็บสื่อการสอนเรื่องค่าประมาณของจำนวนนับ ป.4 แบบ static HTML พร้อมเสียงตอบถูก/ผิด เกมจับเวลาข้อละ 20 วินาที แบบฝึก แบบทดสอบท้ายบท และใบรายงานคะแนน PDF
...
ระบบจะบันทึกผลลง Supabase เฉพาะกรณีผู้เรียนทำแบบทดสอบครบ 20 ข้อ หากหมดเวลา ระบบจะแสดงสรุปบนหน้าจอ แต่ไม่บันทึกผลลงฐานข้อมูล
